...
- Database sẽ được tạo tự động với tên `DemoBai123Db`
- Seed data (Admin user và Roles) sẽ được tạo tự động khi chạy lần đầu

## 🧪 Test Routes

Sau khi chạy ứng dụng, test các routes sau:

1. **Bài 1**: `/Account/Register`
2. **Bài 2**: `/Account/Login`, `/Account/ChangePassword`
3. **Bài 3**: `/Admin/ListRoles`, `/Admin/ManageUserRoles`
